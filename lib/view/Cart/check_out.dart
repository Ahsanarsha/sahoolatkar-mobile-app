            ...
            child: Form(
              ...
              child: Column(
                ...
                itemBuilder: (BuildContext context, int index) {
                  var  productImage = controller.getFromCartModel.cart![index].product!.productImage.toString().replaceAll('"]', '').replaceAll('["', '').replaceAll('\"', "");
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                controller.getFromCartModel.cart![index].product!.name!,
                                                style: GoogleFonts.roboto(
                                                    textStyle:
                                                    productTitle)
                                                    .copyWith(
                                              ...
                                              Text(
                                                "SKU: ${controller.getFromCartModel.cart![index].product!.code}",
                                                style: GoogleFonts.roboto(
                                                    textStyle: heading8)
                                                    .copyWith(
                                                    color: formTextColor,
                                              ...
                                              const SizedBox(height: 8),
                                              Text(
                                                "${controller.getFromCartModel.cart![index].product!.salePrice} - Cash",
                                                style: GoogleFonts.roboto(
                                                    textStyle: heading8)
                                                    .copyWith(
                                                    color: HexColor(
                                            ...
                                            GetBuilder<AddToCartController>(
                                                builder: (controller) =>
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "Quantity: ${controller.getFromCartModel.cart![index].quantity}",
                                                          style: GoogleFonts.roboto(
                                                              textStyle:
                                                              productTitle)
                                                            ..copyWith(
                                                        ...
                                                        Text(
                                                          "Rs. ${double.parse(controller.getFromCartModel.cart![index].quantity.toString())*double.parse(controller.getFromCartModel.cart![index].product!.salePrice.toString())}",
                                                          style: GoogleFonts.roboto(
                                                              textStyle:
                                                              productTitle)
                                                              .copyWith(
                ...
                itemCount:controller.getFromCartModel.cart!.length,
              ),
                  const SizedBox(height: 20),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 12),
                            ...
                            Column(
                              ...
                              children: [
                                GetBuilder<AddToCartController>(builder: (c) {
                                  double _totals = 0;
                                  for (var item in controller.getFromCartModel.cart!) {
                                    var tPrice = double.parse(item.quantity!) * double.parse(item.product!.salePrice.toString());
                  ...
                  InkWell(
                    onTap: ()async{
                      if(_userProfileFormKey.currentState!.validate()){
                        ...
                        for(var items in controller.getFromCartModel.cart!){
                          data.add(ProductDetails(productId: items.product!.id.toString(),qty: items.quantity.toString()));
                        }
