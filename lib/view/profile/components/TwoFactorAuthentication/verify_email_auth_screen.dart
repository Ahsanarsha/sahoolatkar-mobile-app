...
class VerifyEmailAuthScreen extends StatelessWidget {
  VerifyEmailAuthScreen({Key? key,required this.mail}) : super(key: key);
  String mail = '';
                              ...
                              Expanded(
                                child: Pinput(
                                  ...
                                  onCompleted: (pin) async{
                                   ...
                                   await AuthenticationController().verifyCode(
                                        int.parse(pin),context);
