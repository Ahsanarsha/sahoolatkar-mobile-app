...
class BuildPromotions extends StatefulWidget {
  const BuildPromotions({Key? key}) : super(key: key);

  @override
  State<BuildPromotions> createState() => _BuildPromotionsState();
}

class _BuildPromotionsState extends State<BuildPromotions> {
    ...
    return GetBuilder<PromotionController>(
      ...
      builder: (controller){
        return SizedBox(
          ...
          height: 300,
          child: controller.allProducts.prodcuts == null || controller.isFilterLoading ? const Center(child: CircularProgressIndicator()): GridView.builder(
                        ...
                        Column(
                          children: [
                           // const SizedBox(height: 20),
                            ...
                            Text(
                              controller.responseList![index].name.toString(),
