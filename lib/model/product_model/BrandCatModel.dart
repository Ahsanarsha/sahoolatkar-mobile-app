import 'dart:convert';
BrandCatModel brandCatModelFromJson(String str) => BrandCatModel.fromJson(json.decode(str));
String brandCatModelToJson(BrandCatModel data) => json.encode(data.toJson());
class BrandCatModel {
  BrandCatModel({
      String? status, 
      Product? product,}){
  ...
  BrandCatModel.fromJson(dynamic json) {
    _status = json['Status'];
